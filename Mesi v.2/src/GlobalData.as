package
{
	...
	public class GlobalData extends EventDispatcher
	{
		...
		public function setPostCategory(category:String,time:String,paused:String):void
		{
			postCategory = category;
			postTime = time;
		...
		public function setPostLocation(location:String):void
		{
			postLocation = location;
		}
		
		public function updatePostLocation(category:String,time:String):void
		{
			postCategory = category;
			postTime = time;
